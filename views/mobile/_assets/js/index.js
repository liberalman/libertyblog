	...
	$( document ).on( "mobileinit", function(){
		$.widget( "mobile.h2linker", {
			...
			_create:function(){
				var self = this,
					bodyid = "ui-page-top",
					panel = "<div data-role='panel' class='jqm-nav-panel jqm-quicklink-panel' data-position='right' data-display='overlay' data-theme='a'><ul data-role='listview' data-inset='false' data-theme='a' data-divider-theme='a' data-icon='false' class='jqm-list'><li data-role='list-divider'>目录</li></ul></div>",
					first = true,
					...
					this.element.find("div.jqm-content>h2").each(function(){
						...
						if(!first){
							$(this).before( "<a href='#" + bodyid + "' class='jqm-deeplink ui-icon-carat-u ui-alt-icon'>返回顶部</a>");
						} else {
							$(this).before("<a href='#' data-ajax='false' class='jqm-deeplink jqm-open-quicklink-panel ui-icon-carat-l ui-alt-icon' style='border-top:0px solid #eee;'>目录.</a>");
						}
						first = false;
					});
