...
func init() {
	...
	beego.Router("/article/add", &blog.ArticleController{}, "*:Add")
	beego.Router("/article/add1", &blog.ArticleController{}, "*:Add1")
	beego.Router("/article/edit1", &blog.ArticleController{}, "*:Edit1")
