 ...
 * http://git.oschina.net/pandao/editor.md/blob/master/editormd.js
 */
...
(function(factory) {
	...
	var timer, flowchartTimer, vizTimer;
	...
	editormd.prototype = editormd.fn = {
		...
		vizRender: function() {
			...
			this.previewContainer.find(".viz").each(function() {
				var viz = $(this);
				viz.html("<hr>" + Viz(viz.text(), "svg"));
			});
		...
		save: function() {
			...
			if(settings.watch || (!settings.watch && state.preview)) {
				...
				if(settings.viz) {
					if(!editormd.vizLoaded && settings.autoLoadModules) {
						editormd.loadViz(function() {
							editormd.vizLoaded = true;
	...
	editormd.markdownToHTML = function(id, options) {
		...
		if(settings.viz) {
			div.find(".viz").each(function() {
				var viz = $(this);console.info(viz.text());
				viz.html("<hr>" + Viz(viz.text(), "svg"));
			});
		}
	...
	editormd.vizURL = {
		js: "//cdn.bootcss.com/viz.js/1.8.0/viz-lite"
	};

	editormd.vizLoaded = false;
	...
	editormd.loadViz = function(callback) {
		editormd.loadScript(editormd.vizURL.js, callback || function() {});
	};
